        ...
        <Layout title="Loyalty Program | VegClub Magazine">
            <main className="mx-auto border-black/[.1]">
                ...
                <div className="pt-[40px] pb-[20px] sm:px-[40px]">
                    ...
                    <div className="mt-8 cursor-pointer w-fit mx-auto bg-black p-3 text-white uppercase font-semibold duration-[.34s] ease-[cubic-bezier(.19,1,.22,1)] transition-all hover:text-white/[.6] rounded-[2px]"><Link href={{pathname:"/checkout", query:{type:"merchandise", amt:"35"}}}>Purchase now</Link></div>
                </div>
                ...
                <div className={`${isScrollPassedThreshold ? "fixed":"hidden"} bg-white w-[100vw] top-[63px] drop-shadow-md py-2`}>
                        <div className="cursor-pointer w-fit mx-auto  p-3  uppercase transition-all font-semibold duration-[.34s] ease-[cubic-bezier(.19,1,.22,1)] hover:text-black/[.4] rounded-[2px]"><Link href="/checkout">Purchase now</Link></div>
