                ...
                <div className="relative border-[#000]/[.1] border-r-[1px] md:border-r-0">
                    ...
                    <div className="relative inline-block py-[40px] pr-[40px] bottom-[40px] left-[10%] md:left-[0%]  bg-[#000] text-start text-white w-[90%] md:w-full">
                        ...
                        <div className="pl-[40px] md:px-[40px]">
                            ...
                            <h1 className="article-title mt-4 line-clamp-6 font-extrabold w-fit leading-[1.5]  text-[2.074rem] lg:text-[2.488rem]"><span className="underline_span"><Link href={`/article/${encodeURIComponent(articles?.featureArticles[0]?.attributes?.slug)}`}>{articles?.featureArticles[0]?.attributes?.title}</Link></span></h1>
