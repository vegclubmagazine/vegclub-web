    ...
    return (
        <Layout>
            <div className="w-full min-h-[100vh]">
                <div className="w-full bg-white border-box py-5">
                    ...
                    <div className="mt-3">
                        <div className="border-[#cacaca] border-b-[1px]">
                            <div className="w-[80%] mx-auto leading-[2.3rem]">
                                <button className="w-[50%] border-[#01e2c2] border-b-[2px] text-center outline-none  uppercase italic font-semibold text-[black]" onClick={()=>setViewArticleResults(true)}>Articles<span className="ml-2">({results.length})</span></button>
                                ...
                                results.length ? (
                                    <Fragment>
                                        <ul className="decoration-none list-none">
                                            ...
                                            <li className="border-box border-[#CACACA] border-b-[1px]" key={index}>
